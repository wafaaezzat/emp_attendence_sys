            ...
            <div class="card card-secondary card-outline text-center">
                <div class="card-body box-profile ">
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-secondary mb-4 "  id="start-btn"  name="sign_in" >Sign In</button>
                    </div>
                </div>
            </div>
        </form>
                ...
                <form method="GET" action="{{ route('project.signout')}}">
                    ...
                    <div class="card card-secondary card-outline text-center">
                        <div class="card-body box-profile ">
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-secondary mb-4" id="stop-btn" name="sign_out" >Sign Out</button>
                            </div>
                        </div>
                    </div>
                </form>
