    ...
    <section class="content-header">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('TeamLeader.dashboard')}}">Home</a></li>
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-3">
                <form method="post" action="{{ route('TeamLeaderPictureUpdate') }}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="card card-secondary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle TeamLeader_picture" src="{{ url('public/Image/'.Auth::user()->picture) }}" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center TeamLeader_name">{{Auth::user()->name}}</h3>
                            <p class="text-muted text-center">Team Leader</p>
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('TeamLeaderUpdateInfo') }}" id="AdminInfoForm">
                          @csrf
                    ...
                    <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" action="{{ route('TeamLeaderChangePassword') }}" method="POST" id="changePasswordAdminForm">
                          @csrf
                            <div class="form-group row">
