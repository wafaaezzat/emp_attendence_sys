...
class TeamLeaderController extends Controller
{
    function index(Request $request)
    {
        ...
        return view('dashboards.TeamLeaders.index', compact('projects', 'chart', 'project', 'users', 'count', 'chart_effort', 'user'));
    }

    function profile()
    {
        return view('dashboards.TeamLeaders.profile');
    }

    function settings()
    {
        return view('dashboards.TeamLeaders.settings');
    }
    ...
    function updateInfo(Request $request)
    {
        ...
        if (!$validator->passes()) {
            ...
            if (!$query) {
                return view('dashboards.TeamLeaders.profile')->with('error','something wen wrong');
            } else {
                return view('dashboards.TeamLeaders.profile')->with('success','Your profile info has been update successfuly');
            }
        }
    }
